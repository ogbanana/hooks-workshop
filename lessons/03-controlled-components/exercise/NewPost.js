...
export default function NewPost({ takeFocus, date, onSuccess, showAvatar }) {
  ...
  const [message, setMessage] = useState('I promised to exercise today...')
  const messageExceeded = message.length > MAX_MESSAGE_LENGTH
  ...
  return (
    <div className={"NewPost" + (messageExceeded? `${errorClass}`: "")}>
